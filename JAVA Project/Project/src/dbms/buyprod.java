...
public class buyprod extends JFrame {
	...
	static final String DB_URL = "jdbc:mysql://localhost/dbms";
	   ...
	   static final String USER = "puter";
	   static final String PASS = "agentscarn";
	...
	public buyprod(String s,String email) throws SQLException {
    	...
    	contentPane.setBackground(new Color( 56, 93, 56));
...
//	    lblNewLabel_2.setText(String.valueOf(price+d));
		...
		mybutton btnConfirmCod = new mybutton("Confirm");
